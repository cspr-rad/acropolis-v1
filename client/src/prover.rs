...
use k256::ecdsa::{signature::{Keypair, Signer}, Signature, SigningKey, VerifyingKey};
...
fn generate_proof() {
    ...
    payload.append(government_signing_key.verifying_key().to_encoded_point(true).to_bytes().to_vec().as_mut());
